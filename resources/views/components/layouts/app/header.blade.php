            ...
            <flux:dropdown position="top" align="end">
                @if (auth()->user()->profile_picture)
                    <button type="button" class="focus:outline-none focus:ring-2 focus:ring-ocean-500 focus:ring-offset-2 rounded-full">
                        <img src="{{ auth()->user()->profilePictureUrl() }}" alt="{{ auth()->user()->name }}" class="size-10 cursor-pointer rounded-full object-cover">
                    </button>
                @else
                    ...
                    <flux:menu.radio.group>
                        <div class="p-0 text-sm font-normal">
                            <div class="flex items-center gap-2 px-1 py-1.5 text-start text-sm">
                                @if (auth()->user()->profile_picture)
                                    <img src="{{ auth()->user()->profilePictureUrl() }}" alt="{{ auth()->user()->name }}" class="size-8 shrink-0 rounded-full object-cover">
                                @else
