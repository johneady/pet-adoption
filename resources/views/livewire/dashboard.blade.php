<div class="px-4 py-8 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-7xl">
        ...
        @if ($userApplications->isNotEmpty())
            @php
                $application = $userApplications->first();
                $status = $applicationStatuses[$application->status] ?? null;
            @endphp

            <div class="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
                <flux:heading size="lg" class="mb-6">Recent Adoption Application</flux:heading>
                ...
                <div class="grid gap-6 md:grid-cols-3">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <div class="mt-4">
                            ...
                            @if ($application->pet->age)
                                <flux:text class="text-sm">{{ $application->pet->age }} years old</flux:text>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        @if ($status)
                            <div
                                class="mb-4 inline-flex items-center gap-2 rounded-full border px-3 py-1.5
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                <flux:text class="mb-1 text-xs font-medium text-gray-500 dark:text-gray-400">Application
                                    Submitted</flux:text>
                                <flux:text class="text-sm">{{ $application->created_at->format('M j, Y') }}</flux:text>
                            </div>

                            @if ($application->interview)
                                <div>
                                    <flux:text class="mb-1 text-xs font-medium text-gray-500 dark:text-gray-400">
                        ...
                        <!-- Action Button -->
                        <div class="mt-6">
                            <flux:button href="{{ route('pets.show', $application->pet->slug) }}" wire:navigate
                                variant="outline">
                                View Pet Details
                            </flux:button>
                        </div>
        ...
        @else
            <div
                ...
                <div class="text-center">
                    ...
                    <flux:heading size="lg" class="mb-2 mt-4 text-ocean-900 dark:text-ocean-100">No Applications
                        Yet</flux:heading>
