<div class="px-4 py-8 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-7xl">
        ...
        @if ($this->membership && $this->membership->isActive())
            <div
                class="rounded-xl border-2 border-ocean-200 bg-white p-8 shadow-sm shadow-ocean-100 dark:border-ocean-800 dark:bg-zinc-900 dark:shadow-ocean-950 mb-8">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <flux:text class="text-zinc-600 dark:text-zinc-400">Active until
        ...
        @else
            <div
                class="mb-8 rounded-xl border-2 border-ocean-200 bg-white p-8 shadow-sm shadow-ocean-100 dark:border-ocean-800 dark:bg-zinc-900 dark:shadow-ocean-950">
