<x-layouts.app :title="__('Find Your Perfect Companion')">
    @php
        $headerImage = App\Models\Setting::get('header_image') ?: 'images/default_header.jpg';
        $middleImage = App\Models\Setting::get('middle_image') ?: 'images/default_middle.jpg';
        $footerImage = App\Models\Setting::get('footer_image') ?: 'images/default_footer.jpg';
    @endphp
    ...
    <div class="px-4 py-8 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-7xl">
            ...
            <div
                ...
                @if($headerImage) style="background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('{{ asset($headerImage) }}');" @endif>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 py-24">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                        ...
                        <div class="relative">
                            <div
                                class="flex items-center justify-center w-12 h-12 rounded-full bg-ocean-600 text-white font-bold text-xl mb-4">
                                1
                            </div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400">
                                Explore our collection of lovable pets waiting for their forever homes. Filter by
                                species,
                                age,
                                size, and more.
                            </p>
                        ...
                        <div class="relative">
                            <div
                                class="flex items-center justify-center w-12 h-12 rounded-full bg-teal-600 text-white font-bold text-xl mb-4">
                                2
                            </div>
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                                Apply Online
                            ...
                            <p class="text-gray-600 dark:text-gray-400">
                                Found the perfect match? Submit your adoption application online. Our team will review
                                it
                                promptly.
                            </p>
                        </div>
                        ...
                        <div class="relative">
                            <div
                                class="flex items-center justify-center w-12 h-12 rounded-full bg-ocean-700 text-white font-bold text-xl mb-4">
                                3
                            </div>
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                                Bring Them Home
                            ...
                            <p class="text-gray-600 dark:text-gray-400">
                                Once approved, schedule a meet and greet. When you're ready, complete the adoption and
                                welcome
                    ...
                    <div class="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 dark:text-gray-400">Our team helps ensure the best fit
                                            for
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 dark:text-gray-400">Give a deserving pet a second chance
                                            at
                                            happiness.</p>
                                    </div>
                                </div>
                        ...
                        <div class="relative">
                            <div
                                ...
                                style="background-image: url('{{ asset($middleImage) }}');"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-ocean-600 to-teal-600 dark:from-ocean-800 dark:to-teal-800 relative @if($footerImage) bg-cover bg-center @endif"
                @if($footerImage) style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset($footerImage) }}');" @endif>
                <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
                    <div class="mx-auto max-w-2xl text-center">
                        ...
                        <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-ocean-100">
                            Start your adoption journey today. Browse our available pets and find the perfect companion
                            for
                            your
                            family.
                        </p>
