<x-layouts.app :title="__('Find Your Perfect Companion')">
    {{-- Hero Section --}}
    <div class="relative overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
        ...
        <div class="absolute left-1/2 top-0 -z-10 -translate-x-1/2 blur-3xl xl:-top-6" aria-hidden="true">
            <div class="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-blue-200 to-purple-200 dark:from-blue-900 dark:to-purple-900 opacity-30"
    ...
    <div class="bg-white dark:bg-gray-900 py-16">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-3 text-center">
                <div>
                    <div class="text-4xl font-bold text-blue-600 dark:text-blue-400">50+</div>
                    <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">Pets Adopted</div>
                </div>
                <div>
                    <div class="text-4xl font-bold text-purple-600 dark:text-purple-400">50+</div>
                    <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">Available Now</div>
                </div>
                <div>
                    <div class="text-4xl font-bold text-pink-600 dark:text-pink-400">100%</div>
    ...
    <div class="bg-gray-50 dark:bg-gray-800 py-24">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                {{-- Step 1 --}}
                <div class="relative">
                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-blue-600 text-white font-bold text-xl mb-4">
                        1
                    </div>
                ...
                {{-- Step 2 --}}
                <div class="relative">
                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-purple-600 text-white font-bold text-xl mb-4">
                        2
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                        Apply Online
                ...
                {{-- Step 3 --}}
                <div class="relative">
                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-pink-600 text-white font-bold text-xl mb-4">
                        3
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                        Bring Them Home
    ...
    <div class="bg-white dark:bg-gray-900 py-24">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
                ...
                <div class="relative">
                    <div
                        class="aspect-square rounded-2xl bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 flex items-center justify-center">
                        <svg class="w-48 h-48 text-gray-400 dark:text-gray-600" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
            ...
            <div class="mx-auto max-w-2xl text-center">
                ...
                <div class="mt-10 flex items-center justify-center gap-6">
                    <flux:button href="{{ route('home') }}"
                        class="bg-white text-blue-600 hover:bg-gray-100 dark:bg-gray-100 dark:text-blue-700 dark:hover:bg-white text-lg px-8 py-3">
                        Start Browsing
                    </flux:button>
                </div>
            </div>
