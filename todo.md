...
* Add a timezone to the settings table to set what timezone the application is in. Default to Toronto. Add this to the settings in filament. This is a new app so just change the existing migrations and seeds. I will do an artisan migrate:fresh -seed.


* Make the adoptoin form questions dynamic. 
