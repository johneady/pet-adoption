...
* Add a timezone to the settings table to set what timezone the application is in. Default to EST. Add this to the settings in filament. Use the value in the applicatoin when dealing with date.
