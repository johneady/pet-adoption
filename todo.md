...
Remove the badge icon from the membership plan table, as well as all other places it might be used e.g. migrations, seeds, etc... The existing migrations can be changed as I will start over with artisan migrate:fresh --seed


Continue with the Stripe logic
...
* Add a timezone to the settings table to set what timezone the application is in. Default to EST. Add this to the settings in filament.
