...
class InterviewRescheduledAdmin extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Interview Schedule Updated - Administrative Notification',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.interview-rescheduled-admin',
            with: [
